 ...
 */
public class XboxTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_xbox_tab, container, false);
        return rootView;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView myrv=(RecyclerView) view.findViewById(R.id.recyclerviewXBox_id);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(internalCall==false){
                    ...
                    for (DataSnapshot gameSnapshot : dataSnapshot.getChildren()) {
                        ...
                        if (game.getConsole().equals("Xbox")) {
                            lstGame.add(game);
                        }
                    }
