...
public class LoginActivityEmail extends AppCompatActivity {
    ...
    private static final String TAG = "LoginActivityEmail";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLinkToSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LoginActivityEmail.this, SignupActivity.class);
                ...
                .addOnCompleteListener(LoginActivityEmail.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Log.v(TAG, "Email verfied? " + auth.getCurrentUser().isEmailVerified());
