 ...
 */
public class Play4TAb extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_play4_tab, container, false);
        return rootView;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView myrv=(RecyclerView) view.findViewById(R.id.recyclerviewPS4_id);
